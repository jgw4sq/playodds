			...
			<div class="sl-slider">
				...
				<div class="sl-slide item1" data-orientation="horizontal"
					...
					<div class="sl-slide-inner">
						<div class="container">
							<img class="pull-right" src="images/schedule.png" alt="" />
							<h2>Scheduling Management</h2>
							<h3 class="gap">Never worry about creating a schedule again!</h3>
				...
				<div class="sl-slide item2" data-orientation="vertical"
					...
					<div class="sl-slide-inner">
						<div class="container">
							<img class="pull-right" src="images/vacation (1).png" alt="" />
							<h2>Manage Time Off</h2>
							<h3 class="gap">Approve and Handle Time Off</h3>
							<a class="btn btn-large btn-transparent" href="#">Learn More</a>
						</div>
					</div>
				</div>
				...
				<div class="sl-slide item3" data-orientation="horizontal"
					...
					<div class="sl-slide-inner">
						<div class="container">
							<img class="pull-right" src="images/dollar.png" alt="" />
							<h2>Competitive Pricing</h2>
							<h3 class="gap">Our Prices Can't Be Beat!</h3>
							<a class="btn btn-large btn-transparent" href="#">Learn More</a>
						</div>
					</div>
				</div>
			...
			<div class="row-fluid">
				<div class="span9">
					<h4>Pellentesque habitant morbi tristique senectus et netus et
						malesuada fames ac turpis egestas</h4>
					<p class="no-margin">Tristique senectus et netus et malesuada
						fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae,
						ultricies eget, tempor sit amet</p>
				</div>
				<div class="span3">
					<a class="btn btn-success btn-large pull-right"
						href="http://shapebootstrap.net">Free Download Nova</a>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="services">
		<div class="container">
			<div class="center gap">
				<h3>What We Offer</h3>
				<p class="lead">Look at some of the main features of our
					services</p>
			</div>
			...
			<div class="row-fluid">
				<div class="span4">
					<div class="media">
						...
						<div class="media-body">
							<h4 class="media-heading">Employee Management</h4>
							<p>Have all important employee data at the palm of your
								hands.</p>
						</div>
					</div>
				</div>
				...
				<div class="span4">
					<div class="media">
						...
						<div class="media-body">
							<h4 class="media-heading">Smart Schedule Generation</h4>
							<p>Never worry about the hassle of scheduling part time
								employees again. Our smart schedule generation feature allows
								you to create schedules in a variety of ways in a matter of
								seconds.</p>
						</div>
					</div>
				</div>
				...
				<div class="span4">
					<div class="media">
						...
						<div class="media-body">
							<h4 class="media-heading">Schedule Maintenance</h4>
							<p>Easily maintain your working schedule on a day to day
								basis by easily adding shifts, changing workers, etc.</p>
							<br>
						</div>
					</div>
				</div>
				...
				<div class="row-fluid">
					<div class="span4">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Communication (Coming)</h4>
								<p>Our services allow manager to commincate with employees
									about important information, and also allow employees to
									communicate with each other about trading and covering shifts.</p>
							</div>
						</div>
					</div>
					...
					<div class="span4">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Schedule Everywhere (Coming)</h4>
								<p>Take your scheduling with you on the go with our iOS and
									Android apps.</p>
							</div>
						</div>
					</div>
					...
					<div class="span4">
						<div class="media">
							...
							<div class="media-body">
								...
								<p>Got questions or problems? We are here to help!</p>
							</div>
						</div>
					</div>
				</div>
	...
	<section id="recent-works">
		<div class="container">
			<div class="center">
				...
				<p class="lead">Look at some of the recent projects we have
					completed for our valuble clients</p>
			</div>
			<div class="gap"></div>
