...
public class LoginService {
	...
	@Path("{email}/{password}/")
	  @GET
	  @Produces("application/json")
	  public Response signUpUser(@PathParam("email") String email,@PathParam("password") String password) throws Exception {
		...
		Class.forName("com.mysql.jdbc.Driver");  
		 Connection con=DriverManager.getConnection(  
			...
			String sql = "SELECT * FROM STOCKUSERS WHERE email ='"+email+"' AND password='"+password+"'";
