						...
						if(rs.next()){
							...
							if(pass==passw){
								...
								while (rs.next()){
									...
									if(approved==true){
										approvedtimesoff.add(new TimeOff(startTime2,endTime2,0,guard,true,username));
									}
									else{
										notapprovedtimesoff.add(new TimeOff(startTime2,endTime2,0,guard,false,username));
									}
